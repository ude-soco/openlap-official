...
export const visualizationImages = {
  ...
  Area: `<?xml version="1.0" encoding="utf-8"?>
    ...
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        width=${DIMENSION} height=${DIMENSION} viewBox="0 0 130 130" enable-background="new 0 0 130 130" xml:space="preserve">
...
export const chartMetadata = {
  ...
  Bar: {
    ...
    caution: "With many categories it gets crowded — consider sorting or limiting items.",
  },
  Donut: {
