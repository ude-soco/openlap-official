...
const faqItems = [
  ...
  {
    id: uuidv4(),
    question: "How does Open Learning Analytics Platform embody a human-centered approach?",
    answer:
      "Open Learning Analytics Platform adheres to a Human-Centered Learning Analytics (HCLA) philosophy, involving end-users in the flexible definition and creation of personalized analytics indicators—supporting user engagement at every step",
  },
  {
    id: uuidv4(),
    question: "What technologies does Open Learning Analytics Platform use?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. You can explore a working Open Learning Analytics Platform demo here. The GitHub repository is also accessible for code, documentation, and development insights",
  },
  {
    id: uuidv4(),
    question: "Where has Open Learning Analytics Platform been presented or published?",
    answer:
