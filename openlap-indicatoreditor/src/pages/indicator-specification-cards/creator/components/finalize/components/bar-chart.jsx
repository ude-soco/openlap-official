...
const BarChart = () => {
  ...
  }, [dataset, darkMode, visRef.chart.type]);
  ...
  useEffect(() => {
    if (dataset && dataset.rows && dataset.columns) {
      ...
      // Set default values if no valid columns are found
        ...
        series: [
          {
            ...
            data: seriesData,
            field: valueColumn ? valueColumn.field : "default_field",
          },
        ],
        options: {
          ...prevState.options,
