...
import { getUniqueValuesAndCounts } from "../utils/chart-utils.js";
        ...
        <Grid item>
          {options.xaxis.name ? (
            ...
            >
              <Chip
                onDelete={() => {
                  handleDeleteCategoricalOptions(options.xaxis.field);
                  toggleEditPanel("", false);
                }}
                label={
                ...
                <ListItem key={index} disablePadding sx={{ pr: 1 }}>
                  <Grid container alignItems="center" spacing={1}>
                    ...
                    <Grid item xs>
                      <ListItemButton
                        selected={Boolean(
                          options.xaxis.name === colData.headerName,
                        )}
                        onClick={() => {
                    ...
                    <Grid item>
                      <Tooltip
                        title={
                          <Typography variant="body2" sx={{ p: 1 }}>
                            {Boolean(options.xaxis.name === colData.headerName)
                              ? "Edit data"
              ...
              >
                ...
                <Grid item>
                  <Tooltip
                    ...
                    title={
                      <Typography variant="body2" sx={{ p: 1 }}>
                        Create a new column of type <b>categorical</b> from the
                        data table below
                      </Typography>
                    }
                  >
        ...
        <form onSubmit={(e) => handleSubmitNewColumnData(e)}>
          <DialogContent>
            <Typography sx={{ pb: 2, mt: -2 }}>
              What would you like to name the X-Axis?
            </Typography>
            <TextField
              autoFocus
              ...
              {!Boolean(rowData.length) && (
                <>
                  <Typography
                    ...
                    sx={{ pt: 3, pb: 2 }}
                  >
                    How many {columnName.length ? columnName : "categories"}{" "}
                  ...
                  <TextField
                    ...
                    fullWidth
                    label={`Number of ${
                      columnName.length ? columnName : "categories"
                    }`}
